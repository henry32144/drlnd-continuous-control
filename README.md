...
This project is a part of Udacity Deep reinforcement learning nanodegree. Currently, I use [DDPG](https://arxiv.org/abs/1509.02971) to solve the second version of this environment.

The environment of this project is [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.
...
In this project, I only use the following libraries.
...
The `Report.ipynb` file is the solved version and including some descriptions. Or you can follow the instructions in `Continuous_Control.ipynb` to get started with training your own agent!

### (Optional) Challenge: Crawler Environment(Did not solved yet)
